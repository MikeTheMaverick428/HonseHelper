...
pub struct GatherSupportCardsButtonProps {
    #[prop_or(Callback::noop())]
    pub on_complete: Callback<Result<(), String>>,

    #[prop_or("Gather Support Cards".to_string())]
    pub label: String,

    #[prop_or("Gathering Support Cards...".to_string())]
    pub busy_label: String,
}

#[function_component(GatherSupportCardsButton)]
pub fn gather_support_cards_button(props: &GatherSupportCardsButtonProps) -> Html {
